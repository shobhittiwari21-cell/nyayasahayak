...
# ==========================================
# 2. FLATTENED TRANSLATION DICTIONARY
# ==========================================
en = {
...
hi = {
    ...
    "tools_cit": [
        ...
        "किरायानामा (रेंट एग्रीमेंट) - यूपी",
        "किरायेदार बेदखली (Eviction) नोटिस",
        "धारा 138 (चेक बाउंस) नोटिस",
        "MSME भुगतान वसूली नोटिस",
        "कारण बताओ (Show Cause) नोटिस का जवाब",
        "ट्रैफिक चालान छूट/माफी आवेदन"
    ],
    "tools_adv": [
        "जमानत (Bail) आवेदन ड्राफ्टर",
        "हलफनामा (Affidavit) ड्राफ्टर",
        "रिट याचिका के आधार (Art. 226)",
        "अपीलीय निर्णय (Judgment) सारांश",
        "कानून कनवर्टर: IPC से BNS"
    ],
...
if category == ui["tabs"][0] or category == ui["tabs"][1]:
    # Determine which list of tools to show based on the active tab
    ...
    # Grab the exact English name from the list to look up in the PROMPT_VAULT
    tool_idx = current_tools.index(tool)
    en_tool = en_tools_list[tool_idx]

    # Handle 1-Step Research Tools differently (No Question Phase needed)
    if en_tool == "Case Law Summarizer":
        ...
        # Run the powerful Engine for all interactive tools!
